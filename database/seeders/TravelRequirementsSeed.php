...
class TravelRequirementsSeed extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $travel  = [
            [
                'title_1' => 'Travel & Entry Requirements',
                'title_2' => 'Travel insurance contact information',
                'content' => '<p>We understand that unexpected events can occur while traveling, which is why we offer
                ...
                'banner' => 'images/Travel_Insurance.jpg',
                'language'=>'en',
            ],
            [
                'title_1' => 'Travel & Entry Requirements',
