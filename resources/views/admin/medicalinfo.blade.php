                            ...
                            <div class="card-body">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-english" role="tabpanel"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="{{url('cms/medical-information/update')}}" method="post"
                                                      enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <input type="hidden" value="{{$medicalinfo->id}}" name="id">
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Title</label>
                                                            <input type="text" class="form-control" id="title"
                                                                   name="title"
                                                                   value="{{$medicalinfo->title_1}}">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <input type="file" class="form-control" id="banner"
                                                                   name="banner"
                                                                   value="{{$medicalinfo->banner}}">
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Icon</label>
                                                            <input type="file" class="form-control" id="icon"
                                                                   name="icon"
                                                                   value="{{$medicalinfo->icon}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" class="my-editor" id="description"
                                                                  cols="30"
                                                                  rows="10">{!! $medicalinfo->short_description !!}</textarea>
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="{{url('cms/medical-information/update')}}" method="post"
                                                    ...
                                                    @csrf
                                                    <div class="row">
                                                        <input type="hidden" value="{{$medicalinfo_fr->id}}" name="id">
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Title</label>
                                                            <input type="text" class="form-control" id="title_fr"
                                                                   name="title"
                                                                   value="{{$medicalinfo_fr->title_1}}">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <input type="file" class="form-control" id="banner_fr"
                                                                   name="banner"
                                                                   value="{{$medicalinfo_fr->banner}}">
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Icon</label>
                                                            <input type="file" class="form-control" id="icon_fr"
                                                                   name="icon"
                                                                   value="{{$medicalinfo_fr->icon}}">
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="">Description </label>
                                                        <textarea name="description" class="my-editor"
                                                                  id="description_fr"
                                                                  cols="30"
                                                                  rows="10">{!! $medicalinfo_fr->short_description !!}</textarea>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="content_1" class="my-editor" id="content_1_fr"
                                                                  cols="30"
                                                                  rows="10">{!! $medicalinfo_fr->content_1 !!}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Content 2</label>
                                                        <textarea name="content_2" class="my-editor" id="content_2_fr"
                                                                  cols="30"
                                                                  rows="10">{{ $medicalinfo_fr->content_2 }}</textarea>
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="{{url('cms/medical-information/update')}}" method="post"
                                                    ...
                                                    @csrf
                                                    <div class="row">
                                                        <input type="hidden" value="{{$medicalinfo_cn->id}}" name="id">
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Title</label>
                                                            <input type="text" class="form-control" id="title_cn"
                                                                   name="title"
                                                                   value="{{$medicalinfo_cn->title_1}}">
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Banner</label>
                                                            <input type="file" class="form-control" id="banner_cn"
                                                                   name="banner"
                                                                   value="{{$medicalinfo_cn->banner}}">
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <label for="">Icon</label>
                                                            <input type="file" class="form-control" id="icon_cn"
                                                                   name="icon"
                                                                   value="{{$medicalinfo_cn->icon}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Description </label>
                                                        <textarea name="description" class="my-editor"
                                                                  id="description_cn"
                                                                  cols="30"
                                                                  rows="10">{!! $medicalinfo_cn->short_description !!}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Content 1</label>
                                                        <textarea name="content_1" class="my-editor" id="content_1_cn"
                                                                  cols="30"
                                                                  rows="10">{!! $medicalinfo_cn->content_1 !!}</textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Content 2</label>
                                                        <textarea name="content_2" class="my-editor" id="content_2_cn"
                                                                  cols="30"
                                                                  rows="10">{{ $medicalinfo_cn->content_2 }}</textarea>
                                                    </div>
                                                    <button class="btn btn-sm btn-outline-success">
                                                        Update
                                                    </button>
