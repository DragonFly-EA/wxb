                ...
                <div class="left-top-desktop-links">
                    <ul data-aos="">
                        ...
                        <li><a>
                                ...
                                <p>Travel Alerts: <b>Suspension of Mumbai flights.</b></p>
        ...
        <div class="container-rigid bottom-desktop-links">
            <div class="display-align">
                <div class="desktop-logo-wrapper" data-aos="">
                    <figure><a href="index.html"><img src="{{asset('assets/site/images/rwandairlogo.png')}}"></a></figure>
                </div>
                            ...
                            <ul class="desktop-main-links-invisible">
                                ...
                                <div class="dropdown-links-columns">
                                    ...
                                    <div class="dropdown-links-style">
                                        ...
                                        <li><a href="onboard-connectivity.html">Onboard Connectivity "Wi-Fi"</a></li>
                            ...
                            <ul class="desktop-main-links-invisible">
                                ...
                                <div class="dropdown-links-columns">
                                    ...
                                    <div class="dropdown-links-style">
                                        ...
                                        <li><a href="mailto:Invoices@rwandair.com">Invoice: Invoices@rwandair.com</a>
                                        </li>
            ...
            <div class="desktop-account-signup" data-aos="">
                <ul class="display-align">
                    <li><a href="search.html" class="display-align"><i class="fi fi-rr-search"></i></a></li>
                    <li><a href="search.html"><i class="fa-solid fa-dollar-sign"></i><p>USD</p></a></li>
                    <li class="desktop-main-links-visible">
                    ...
                    <li class="desktop-main-links-visible"><a href="" class="question-link"><i
                        ...
                        <ul class="desktop-main-links-invisible">
                            ...
                            <div class="dropdown-links-columns">
                                <h3>Contact Us</h3>
                                <div class="dropdown-links-style">
                                    <li><a href="contact-us.html">Reservations : reservations@rwandair.com</a></li>
                                    ...
                                    <li><a href="contact-us.html">Customer relations:
                                            customerrelations@rwandair.com</a></li>
                                    <li><a href="contact-us.html">Lost and found: Lostandfound@rwandair.com</a></li>
