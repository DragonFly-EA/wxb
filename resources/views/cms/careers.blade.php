        ...
        <div class="careers-page">
                ...
                <div class="container-rigid">
                    <div class="careers-banner-figure">
                        <figure data-aos="fade-left">
                            <img src="{{asset('images/careers-icon.png')}}" alt="Rwandair Careers" loading="lazy">
                        </figure>
                    </div>
                ...
                <div class="container-rigid">
                    <div class="breadcrumbs-list">
                        <ul>
                            ...
                            <li data-aos="fade-right"><a href="{{url('fleet')}}" class="active-crumb"><p>Careers</p></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-rigid">
                ...
                <div class="become-part-list">
                    ...
                    <ul>
                        ...
                        <li data-aos="zoom-in">
                            <a href="">
                                <figure><img src="{{asset('images/plan-care.svg')}}" alt="Plan Care"></figure>
                        ...
                        <li data-aos="zoom-in">
                            <a href="">
                                <figure><img src="{{asset('images/plan-requirements.svg')}}" alt="Plan Requirements"></figure>
            ...
            <div class="home-offers-slider">
                <ul class="bxslider">
                    ...
                    @empty
                        <li>
                            <img src="{{asset('images/Kamembe.jpg')}}" alt="Kamembe"/>
                            <div class="bx-caption">
                                <div class="display-caption">
                                    <div class="slider-vertical">
            ...
            <div class="container-rigid">
                ...
                <div class="career-stats">
                    <ul>
                        <li data-aos="zoom-in">
                            <a href="">
                                <figure><img src="{{asset('images/career-cabin.svg')}}" alt="career-cabin"></figure>
                        ...
                        <li data-aos="zoom-in">
                            <a href="">
                                <figure><img src="{{asset('images/career-admin.svg')}}" alt="career-admin"></figure>
                                <div class="career-stats-details">
                                    <span>9</span>
                                    <h4>Airplanes</h4>
                                </div>
                        ...
                        <li data-aos="zoom-in">
                            <a href="">
                                <figure><img src="{{asset('images/career-cockpit.svg')}}" alt="career"></figure>
                                <div class="career-stats-details">
                                    <span>342</span>
                                    <h4>Flights</h4>
                                </div>
                        ...
                        <li data-aos="zoom-in">
                            <a href="">
                                <figure><img src="{{asset('images/career-grad.svg')}}" alt="creer-grad"></figure>
                                <div class="career-stats-details">
                                    <span>129</span>
                                    <h4>Countries</h4>
                                </div>
