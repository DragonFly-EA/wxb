            ...
            <div class="help-center-page">
                ...
                <div class="help-center-reservation">
                    ...
                    <div class="help-center-reservation-title">
                        <h3 data-aos="fade-right"><i class="fi fi-rr-plane-departure"></i><b>Already have a reservation?</b><a href="">You can access your reservation from here.</a></h3>
                    </div>
                    ...
                    <div class="help-center-reservation-table">
                        ...
                        <div class="help-center-reservation-column1">
                            ...
                            <p data-aos="fade-right">Begin session to view information about your upcoming flights. You can also access flight information with your booking number and email address or the surname of any passenger on your booking.</p>

                            <div class="align-bottom">
                                <h5 data-aos="fade-right"><i class="fi fi-rr-envelope-download"></i><b>Don't you remember the booking number?</b><a href="">Resend confirmation email</a></h5>
                            </div>
                        </div>
                        ...
                        <diiv class="help-center-reservation-column2">
                            <form>
                                ...
                                <div class="help-form-button" data-aos="fade-left"><button type="submit">Continue</button></div>
