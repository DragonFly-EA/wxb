            ...
            <div class="wifi-page">
                            ...
                            <li data-aos="zoom-in">
                                <a href="">
                                    ...
                                    <div class="plan-trip-caption">
                                        <h4>1 hour pass</h4>
                                        <p>Deactivate automatic updates on your device for an optimized control of your consumption</p>
                ...
                <div class="container-rigid">
                    ...
                    <div class="fleet-table">
                        <div class="fleet-plane-details">

                            <table>
                                <tr>
                                    <td data-aos="fade-up">Basic</td>
                                    <td data-aos="fade-up">Plan</td>
                                </tr>
                                <tr>
                                    <td data-aos="fade-up">Cost</td>
                                    <td data-aos="fade-up">$3 per hour</td>
                                </tr>
                                <tr>
                                    <td data-aos="fade-up">Speed</td>
                                    <td data-aos="fade-up">Up to 5 Mbps</td>
                                </tr>
                                <tr>
                                    <td data-aos="fade-up">Suitability</td>
                                    <td data-aos="fade-up">For light browsing and checking emails</td>
                                </tr>
                    ...
                    <div class="policies-wrapper">
                        <!--<div class="policies-icon"><figure><i class="fi fi-rr-user-lock"></i></figure></div>-->
                            <div class="policies-content">
                                ...
                                <h3 data-aos="fade-up">Manage your booking</h3>

                                <p data-aos="fade-up">Purchasing Extra Baggage online allowed only on ET direct flights. If your flight includes connection flights with other airlines, Please pay at origin flight check in counter</p>

                                <p data-aos="fade-up">Manage your Airlines Booking by providing your last name and the Six-Digit alphabet Code on the Booking reference field and Retrieve your Booking</p>

                                <div class="wifi-book-tab">
                                    <form>
                                        ...
                                        <div class="form-tab-lists">
                                            <ul>
                                                ...
                                                <li data-aos="fade-up"><input type="text" placeholder="Booking Reference"></li>
                                                <li data-aos="fade-up"><input type="text" placeholder="Last Name"></li>

                                                <li data-aos="fade-up">

                                                    <div class="submit-form-button"><button type="submit">Retrieve Booking</button></div>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <h3 data-aos="fade-up">How to find your booking reference</h3>
                                <p data-aos="fade-up">Reference number is a six-character code on your booking confirmation or E-ticket to uniquely identify your booking. It could be referred to as PNR, Record Locator or Reference Number. Valid characters in a booking reference are letters A-Z.</p>

                                <ul>
                                    <li data-aos="fade-up"><a href="">Car Rental</a></li>
                                    <li data-aos="fade-up"><a href="">Airport Transfer</a></li>
                                </ul>



                                <div class="connect-wifi-wrapper">
                                    <h3 data-aos="fade-up">How to connect to WI-FI</h3>
                                    <ol>
                                        <li data-aos="fade-up">
                                            <figure><i class="fi fi-rr-gears"></i></figure>
                                            <b><h5>1</h5></b>
                                            <p>Go to settings</p>
                                        </li>
                                        ...
                                        <li data-aos="fade-up">
                                            <figure><i class="fi fi-rr-wifi"></i></figure>
                                            <b><h5>3</h5></b>
                                            <p>Turn your Wi-Fi on and select RAInternet</p>
                                        </li>

                                        <li data-aos="fade-up">
                                            <figure><i class="fi fi-rr-globe"></i></figure>
                                            <b><h5>4</h5></b>
                                            <p>You will be redirected to our portal page</p>
                                        </li>
                                    </ol>
                                </div>
                    ...
                    <div class="container-rigid">
                        ...
                        <div id="horizontalTab">
                            ...
                            <ul class="resp-tabs-list">
                                ...
                                <li data-aos="fade-up">
                                    <figure><i class="fi fi-sr-person-seat-reclined"></i></figure>
                                    <h3>FAQs</h3>
                                </li>
                                <li data-aos="fade-up">
                            ...
                            <div class="resp-tabs-container">
                                <div class="where-to-purchase">
                                    <h4 data-aos="fade-up">Where to purchase these service</h4>
                                    <p data-aos="fade-up">You can purchase from Rwandair ticket offices, at check-in counter, at boarding gate, onboard from the cabin crew with cash, and using credit card for your own.</p>
                                </div>

                                <div class="wifi-terms">
                                    <h4 data-aos="fade-up">Terms & Conditions</h4>
                                    ...
                                    <div class="application">
                                        ...
                                        <div class="faqs-wrapper">
                                           ...
                                           <ul class="faqs">
                                             ...
                                             <li data-aos="fade-up">
                                                  <a href="#" class="question">How do I know if the Aircraft has W-FI available?</a>
                                                <div class="desc">
                                ...
                                <div class="app-qr-code">
                                    <h4 data-aos="fade-up">Scan QR Code</h4>
                                    <figure data-aos="fade-up"><img src="images/rwandair-code.png"></figure>
                                </div>
