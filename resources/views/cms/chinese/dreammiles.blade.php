        ...
        <div class="fleet-page">
            ...
            <div class="breadcrumbs-wrapper">
                <div class="container-rigid">
                    <div class="breadcrumbs-list">
                        <ul>
                            <li data-aos="fade-right"><a href="about-us.html"><p>Loyalty</p><i class="fi fi-rr-angle-small-right"></i></a></li>
                            <li data-aos="fade-right"><a href="dreammiles.html" class="active-crumb"><p>Dreammiles</p></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container-rigid">
                <div class="fleet-lists">
                    ...
                    <ul>
                        <li data-aos="fade-up">
                            <figure><img src="images/emerald.png"></figure>
                        ...
                        <li data-aos="fade-up">
                            <figure><img src="images/silver.png"></figure>
                            <div class="fleet-details">
                                <div class="fleet-title">
                                    <h3>One Airbus A330 – 300</h3>
                                    <h4>Seating Capacity:</h4>
                        ...
                        <li data-aos="fade-up">
                            <figure><img src="images/gold.png"></figure>
                            <div class="fleet-details">
                                <div class="fleet-title">
                                    <h3>One Airbus A330 – 300</h3>
                                    <h4>Seating Capacity:</h4>
                        ...
                        <li data-aos="fade-up">
                            <figure><img src="images/diamond.png"></figure>
                            <div class="fleet-details">
                                <div class="fleet-title">
                                    <h3>One Airbus A330 – 300</h3>
                                    <h4>Seating Capacity:</h4>
