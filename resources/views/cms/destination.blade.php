        ...
        <div class="dest-cont-wrap">
            <div class="container-rigid">
                <div class="luggage-checkin-row">
                    ...
                    <div class="luggage-checkin-icon-column">
                        <figure>
                            <img src="{{asset('images/buggage-luggage.svg')}}" alt="{{$destination}}">
                        </figure>
            ...
            <div class="container-rigid">
                ...
                <div class="sustainability-sponsors">
                    <ul>
                        <li data-aos="fade-up">
                            <figure><img src="{{asset('images/sustainability-corporate.jpg')}}" alt="sustainability"></figure>
                        ...
                        <li data-aos="fade-up">
                            <figure><img src="{{asset('images/sustainability-sponsorship.jpg')}}" alt="sustainability"></figure>
                            <div class="media-center-caption">
                                <h3>Sponsorship</h3>
                        ...
                        <li data-aos="fade-up">
                            <figure><img src="{{asset('images/sustainability-tender.jpg')}}" alt="tender"></figure>
                            <div class="media-center-caption">
                    ...
                    <div class="dont-miss-offer-columns-style dont-miss-offer-column1">
                        <ul>
                            <li data-aos="fade-right">
                                <figure><img src="{{asset('images/London_Thumbnail.jpg')}}" alt="london"></figure>
