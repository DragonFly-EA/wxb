...
@section('content')
    {{--    <link rel="stylesheet" href="http://flyingwithdragonfly.com/dist/phoenix/V1.0/css/bootstrap.min.css">--}}
    <style>
        #map {
            height: 700px;
        }
    ...
    <script>
            ...
            map = new google.maps.Map(document.getElementById("map"), {
                ...
                styles: [
                    ...
                    },
                    {
                        ...
                        stylers: [
                            { color: "#00509E" } // Set the color for the borderlines
                        ]
                    }
                ]
            });
        ...
        function updateDestinations(selectedValue, airports, selectedToAirportCode) {
            ...
            airportsTo.forEach(function (airport) {
                geocodeAddress(airport.municipality, function (city) {
                    var markerColor = selectedAirports.includes(airport.iata_code) ? "#ffb703" : "#00509E";
                    var marker = new google.maps.Marker({
                        position: city,
                        map: map,
                        title: airport.municipality,
