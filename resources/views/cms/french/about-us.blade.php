                ...
                <div class="container-fluid">
                    <figure>
                        @if(strpos($about->banner, "about/") !== false)
                            <img src="{{asset('').'storage/'.$about->banner}}">
                        @else
                            <img src="{{asset('').$about->banner}}">
                        @endif
                    </figure>
                </div>
            </div>
                            ...
                            <div class="accreditation-details-row" data-aos="fade-right">
                                <figure>
                                    @if(strpos($about->icon_1, "about") !== false)
                                        <img src="{{asset('').'storage/'.$about->icon_1}}">
                                    @else
                                        <img src="{{asset('').$about->icon_1}}">
                                    @endif
                                </figure>
                                {!! $about->content_1 !!}
                            </div>
                            ...
                            <div class="accreditation-details-row" data-aos="fade-right">
                                <figure>
                                    @if(strpos($about->icon_2, "about") !== false)
                                        <img src="{{asset('').'storage/'.$about->icon_2}}">
                                    @else
                                        <img src="{{asset('').$about->icon_2}}">
                                    @endif
                                </figure>
                                {!! $about->content_2 !!}
                            </div>
                        ...
                        <div class="accreditation-image-column" data-aos="fade-left">
                            <figure>
                                @if(strpos($about->banner_2, "about") === true)
                                    <img src="{{asset('').'storage/'.$about->banner_2}}">
                                @else
                                    <img src="{{asset('').$about->banner_2}}">
                                @endif
                            </figure>
                        </div>
                    </div>
