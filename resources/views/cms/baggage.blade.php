                ...
                <div class="container-rigid">
                    <figure>
                        @if(strpos($baggage->image1, "baggage/") !== false)
                            <img src="{{asset('').'storage/'.$baggage->image1}}" alt="">
                        @else
                            <img src="{{asset('').$baggage->image1}}" alt="">
                        @endif
                    </figure>
                    ...
                    <div class="luggage-checkin-icon-column">
                        <figure>
                            ...
                            @if(strpos($baggage->image2, "baggage/") !== false)
                                <img src="{{asset('').'storage/'.$baggage->image2}}" alt="{{$baggage->title4}}">
                            @else
                                <img src="{{asset('').$baggage->image2}}" alt="{{$baggage->title4}}">
                            @endif
                        </figure>
                    ...
                    <div class="luggage-checkin-icon-column">
                        <figure>
                            @if(strpos($baggage->image3, "baggage/") !== false)
                                <img src="{{asset('').'storage/'.$baggage->image3}}" alt="{{$baggage->title5}}">
                            @else
                                <img src="{{asset('').$baggage->image3}}" alt="{{$baggage->title5}}">
                            @endif
                        </figure>
                        <div class="luggage-checkin-icon">
