            ...
            <div class="container-rigid">
                <div class="single-fleet-seats">
                    ...
                    <ul>
                        ...
                        <li>
                            <figure><img src="{{asset('images/seat-first.jpg')}}" alt="seat-fleet"></figure>
                        ...
                        <li>
                            <figure><img src="{{asset('images/seat-premium.jpg')}}" alt="seat"></figure>
                            <div class="single-fleet-seat-details">
                ...
                <div class="single-fleet-infotainment">
                    <ul>
                        <li>
                            <figure><img src="{{asset('images/seat-entertainment.jpg')}}" alt="seat"></figure>
                        ...
                        <li>
                            <figure><img src="{{asset('images/seat-meals.jpg')}}" alt="seat"></figure>
                            <div class="single-fleet-infotainment-details">
