...
class BookController extends Controller
{
    public function index(){
        $sliders = Slider::where('enable',true)->where('language','en')->orderBy('id')->get();
        $menus = Menu::where('language','en')->with('titles')->orderBy('id')->get();
        return view('cms.book',compact('sliders','menus'));
    }
    public function french(){
        ...
        return view('cms,french.book',compact('sliders','menus'));
    }
    public function chinese(){
        ...
        return view('cms.chinese.book',compact('sliders','menus'));
    }
}
